...
export default function SignupPage() {
  ...
  return (
    ...
    >
      ...
      {/* Glass card */}
      <div
        className="w-full max-w-[440px] page-enter relative"
        style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <Input label="Name" type="text" placeholder="Your full name"
            ...
            required containerStyle={{ marginBottom: '20px' }} />
          ...
          <p className="text-[11.5px] text-[var(--color-text-muted)] mb-8 font-sans select-none">
        ...
        <div className="text-center font-sans text-[14px] text-[var(--color-text-secondary)] select-none">
          ...
          <Link href="/login" className="text-[var(--color-accent)] font-medium hover:underline hover:text-[var(--color-accent-hover)] transition-all">
            Sign in
          </Link>
        </div>
      </div>
